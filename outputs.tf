...
output "private_subnet_ipv6_cidr_blocks" {
  value = aws_subnet.private_subnet.*.ipv6_cidr_block_association[0].ipv6_cidr_block
}

output "intra_subnet_ipv6_cidr_blocks" {
  value = aws_subnet.intra_subnet.*.ipv6_cidr_block_association[0].ipv6_cidr_block
}
